...
void BitcoinGUI::createActions()
{
    ...
    manageNamesAction->setStatusTip(tr("Manage names registered via Loopcoin"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    {
        trayIcon->setToolTip(tr("Loopcoin client") + QString(" ") + tr("[testnet]"));
        trayIcon->setIcon(QIcon(":/icons/toolbar_testnet"));
    }
    trayIcon->show();
#endif
